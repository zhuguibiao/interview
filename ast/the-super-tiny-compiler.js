 ...
 *行的实际代码。 remove all the comments this file would only be ~200 lines of actual code.
 *
 *像 We're going to compile some lisp-like function calls into some C-like
 * function calls.
 *
